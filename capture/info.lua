...
info.buildCharBox = function()
    ...
    info.vars.char = { box = texts.new(), settings = info.settings.char_box }
...
info.buildTargetBox = function()
    ...
    info.vars.target = { box = texts.new(), settings = info.settings.target_box }
...
info.buildWorldBox = function()
    ...
    info.vars.world = { box = texts.new(), settings = info.settings.world_box }
